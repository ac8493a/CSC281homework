...
//---------- POLYWHIRL HAS BEGUN EXECUTION ----------
    ...
    public void  readAndGenerateShapes() {
         ...
         int numShapes = Integer.parseInt(scan.nextLine()); 
         Scanner val= new Scanner(System.in);

       
        for (int i = 0; i < numShapes; i++) {
          int[] array = new int[3]; //create array with 3 empty slots
          System.out.println("Enter the # of sides: ");
          array[0]=val.nextInt();
          ...
          array[2]=val.nextInt();
           ...
           if (array[0]==3) {
            this.tri.add (new Tri(array[1],array[2]));
}
           if (array[0]==4) {
             this.quad.add (new Quad(array[1],array[2]));
}

           if (array[0]==5) {
             this.pent.add (new Pent(array[1],array[2]));
 }   


           if (array[0]==6) {
             this.crystal.add (new Crystal(array[1],array[2]));
 } 
