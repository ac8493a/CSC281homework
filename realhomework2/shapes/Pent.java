...
public class Pent extends BasicShape {
  ...
  public void draw(Graphics g) {
     ...
     * means that the ith point is made of up the ith index of xPoints and yPoints.
     ...
     */
    // specify the color
    Color strokeColor = new Color(0, 235, 235, 255);
    ...
    Color fillColor = new Color(144, 242, 124, 200);
